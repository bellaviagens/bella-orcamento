...
export const travelClients = mysqlTable("travel_clients", {
  ...
  passportExpiresAt: varchar("passportExpiresAt", { length: 10 }),
  rgNumber: varchar("rgNumber", { length: 100 }),
  rgExpiresAt: varchar("rgExpiresAt", { length: 10 }),
  visaNumber: varchar("visaNumber", { length: 100 }),
  visaExpiresAt: varchar("visaExpiresAt", { length: 10 }),
