...
describe("hotelVoucherUpdates", () => {
  ...
  it("preserva todos os dados já preenchidos pela consultora", () => {
    const updates = hotelVoucherUpdates({
      ...
      hotelCheckIn: "2026-09-09", hotelCheckOut: "2026-09-15", hotelAddress: "Endereço digitado", hotelPhone: "11999990000", hotelLocator: "MANUAL", hotelGuestName: "Cliente Manual",
    }, parsedVoucher);

    expect(updates).toMatchObject({
      title: "Hotel já escolhido", hotelCheckIn: "2026-09-09", hotelCheckOut: "2026-09-15", hotelAddress: "Endereço digitado", hotelPhone: "11999990000", hotelLocator: "MANUAL", hotelGuestName: "Cliente Manual",
    });
  });
});
