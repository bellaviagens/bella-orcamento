          ...
          {!isCollapsed && <div className="space-y-3">
            ...
            <div className="rounded-md border border-slate-200 bg-white p-3">
              ...
              <div className="mb-3 rounded-md border border-blue-100 bg-blue-50 px-3 py-2 text-xs leading-relaxed text-[#1a2e4a]">
                <strong>Ordem da agenda:</strong> a sequência abaixo será exibida exatamente assim na prévia e no PDF. Use os botões <strong>Subir</strong> e <strong>Descer</strong> em cada compromisso para reorganizar o dia, mesmo que o print tenha sido importado fora de ordem.
              </div>
