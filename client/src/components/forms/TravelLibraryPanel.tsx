...
export function TravelLibraryPanel({ initiallyOpen = false }: { initiallyOpen?: boolean }) {
  ...
  const items = useMemo(() => filterTravelLibraryItems(allItems, { category: selectedCategory, country: selectedCountry, city: selectedCity, neighborhood: selectedNeighborhood }), [allItems, selectedCategory, selectedCountry, selectedCity, selectedNeighborhood]);
