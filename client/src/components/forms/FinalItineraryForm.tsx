  ...
  return (
    <div className="space-y-4">
      ...
      <section className="rounded-lg border border-[#1a2e4a]/15 bg-white p-3">
        <div className="mb-3 flex items-center justify-between gap-2">
          <div className="flex items-center gap-2 text-sm font-bold text-[#1a2e4a]"><Luggage className="h-4 w-4" />Regras de bagagem</div>
        ...
        {(finalItinerary.passengers || []).length > 0 ? <div className="hidden mt-3 space-y-2">{finalItinerary.passengers?.map((passenger) => {
