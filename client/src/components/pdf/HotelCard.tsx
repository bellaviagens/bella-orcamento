  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white overflow-hidden shadow-sm">
      ...
      <div className="p-5">
        ...
        {/* Payment Methods Block - Individual for each hotel with installment calculator */}
        {hotelPaymentMethods && hotelPaymentMethods.length > 0 && (
          <div className="mt-4 pt-4 border-t border-slate-200">
            <div className="rounded-lg border border-slate-200 p-4 bg-white">
              ...
              <div className="text-2xl font-bold text-[#1a2e4a] mb-1">
              ...
              <div className="flex flex-wrap gap-2">
                {hotelPaymentMethods.map((method) => (
                  <span key={method} className="inline-block px-3 py-1.5 rounded text-xs font-medium bg-blue-100 text-blue-700">
