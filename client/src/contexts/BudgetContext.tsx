...
interface BudgetContextType {
  ...
  updateInstallments: (field: "flight" | "hotel" | "combined" | "hotelDownpayment" | "hotelDownpaymentAmount", value: number | boolean | undefined) => void;
...
export function BudgetProvider({ children }: { children: ReactNode }) {
  ...
  const updateInstallments = useCallback((field: "flight" | "hotel" | "combined" | "hotelDownpayment" | "hotelDownpaymentAmount", value: number | boolean | undefined) => {
    setBudget((prev) => ({
      ...prev,
      installments: {
        ...prev.installments,
